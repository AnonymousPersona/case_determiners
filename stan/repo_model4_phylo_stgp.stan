...
generated quantities {
  ...
  // include nugget in denominator; tiny eps to avoid division by zero
  real tiny = 1e-12;
  ...
  // prior allocation to space-time GP
